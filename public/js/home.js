function home() {
    ...
    <div class="toolbox left">
        ...
        <div class="group tools">
            ...
            <div class="item active" data-tool="rectangle" title="Rectangle Tool"><img
                    src="images/rect-icon.png">
            </div>
            <div class="item" data-tool="circle" title="Circle Tool"><img src="images/circle-icon.png">
            </div>
            <div class="item" data-tool="triangle" title="Triangle Tool"><img src="images/tri-icon.png">
            </div>
        </div>
        <div class="group tools">
            <div class="item" data-tool="pencil" title="Pencil Tool"><img src="images/pencil-icon.png">
            </div>
            <div class="item" data-tool="eraser" title="Eraser Tool"><img src="images/eraser-icon.png">
            </div>
        </div>
    </div>
