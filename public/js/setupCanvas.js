//copied from the 'load' event listener callback function in draw.js
//this is called again whenever the user navigates to a canvas page

function setupCanvas() {
    var selectedColor = "black";
    console.log("setupCanvas was called.");
    var socket = io();
